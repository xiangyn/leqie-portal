$.fn.sider=function(q){function d(b,c,d){if(b){/*var h=f/(a.max-a.min),e=b*h,e=e>f?f:0>e?0:e;d?e-=h*a.min:b+=a.min;b=b>a.max?a.max:b<a.min?a.min:b;*/k.val(b);/*l.css({left:e})*/}c&&g.hide();a.callback&&q.callback(m,b,c)}var a={step:1,min:0,max:100,quick:[0,5,10,15,30,40,60,80],name:"size",placeholder:"",value:"",callback:!1};$.extend(a,q);$(this).html('<input type="text" name="'+a.name+'" value="'+a.value+'" placeholder="'+a.placeholder+'" class="form-control" readonly="readonly"><div class="popcontent"><ul></ul><div class="sider"><div class="sider-btn"></div></div></div>');
