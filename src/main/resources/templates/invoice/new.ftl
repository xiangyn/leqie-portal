					...
					<form id="_form">
						<div class="form-content">
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="duigongzhanghu" type="text" placeholder="请输入对公账户" required="required" />
									</div>
							...
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="gongsizhucedizhi" type="text" placeholder="请输入公司注册地址" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="gongsizhucezuojihao" type="text" placeholder="请选择公司注册座机号" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="kaipiaotaitou" type="text" placeholder="请输入开票抬头" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="shuihao" type="text" placeholder="请输入税号" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="shoujianren" type="text" placeholder="请输入收件人" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="shoujiandizhi" type="text" placeholder="请输入收件地址" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="shoujihao" type="text" placeholder="请输入手机号" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="yingyewangzhi" type="text" placeholder="请输入营业网址" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
							<div class="row">
								...
								<div class="col half">
									<div class="form-item">
										<input name="zhanghukaihuhang" type="text" placeholder="请输入账户开户行" required="required" />
									</div>
									<span class="form-item-msg"></span>
								</div>
							</div>
...
$(function() {
	...
	$("#_form").on("submit", function() {
		if(validate()) {
			$.fastAjax({
				url: "${ctx}/app/invoice/save.jo",
				data: $("#_form").serializeObject(),
				success: function(ret) {
					if(ret.success) {
						$.info.success('添加发票信息成功!', success);
					}else {
						$.info.error('添加发票信息失败，请刷新后再试!');
					}
				}
			});
		}
