			...
			<div class="col-right orders-panel">
				...
				<div class="panel-title">
					<ul class="order-menus">
						<li class="order-menu-item active"><a href="${ctx}/app/invoice/record-wait.jhtml">等待中</a></li>
						<li class="order-menu-item"><a href="${ctx}/app/invoice/record-finished.jhtml">已完成</a></li>
					</ul>
				</div>
