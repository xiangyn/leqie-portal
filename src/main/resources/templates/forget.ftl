	...
	<div class="navbar">
		<div class="container">
			<div class="row">
				...
				<div class="col right">
					<a class="color-hover" href="${ctx}/app/register.jhtml">注册</a>
					<a class="color-hover" href="${ctx}/app/login.jhtml">登录</a>
				</div>
			</div>
		</div>
	</div>
	<div class="register-body">
		<div class="container clearfix">
			<div class="left register-content">
				<h1 class="register-title">填写信息</h1>
				<form class="register-form">
					...
					<div class="row">
						<div class="form-item text-center">
							<button type="submit" class="btn"> 点击修改密码 </button>
						</div>
					</div>
				</form>
			</div>
			...
			$.ajax({
				...
				success: function(ret) {
					if(ret.success) {
						...
						iziToast.error({
					        message: '修改密码，请检查你的验证码是否正确,或你的账号不存在!',
					        position: 'topCenter',
					        transitionIn: 'bounceInLeft',
					    });
					}
